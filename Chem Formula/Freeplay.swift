    ...
    func displayOtherOptions(){
        ...
        for(var c = 0; c < 4; c += 1){
            ...
            if(c != correctAnionSymbol){
                ...
                while(anionSymbols[c] == "" || anionSymbols[c] == anionSymbol || ionToolsObj.getRepeated(anionSymbols[0], s1: anionSymbols[1], s2: anionSymbols[2], s3: anionSymbols[3], c: c)){
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch in touches{
            ...
            if(playing == true){
                ...
                if((nodeAtPoint(location) == cationSymbols[correctCationSymbol] || nodeAtPoint(location) == cationSymbolsText[correctCationSymbol]) && noOfCationSelected < noOfCation){
                ...
                else if((nodeAtPoint(location) == anionSymbols[correctAnionSymbol] || nodeAtPoint(location) == anionSymbolsText[correctAnionSymbol]) && noOfAnionSelected < noOfAnion){
